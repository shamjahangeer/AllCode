#!/usr/bin/sh
#
# Online Complete backup of the RAC database
#
#
# MODIFIED
...
{
   echo "" >&2
   echo "Usage:  onlinebackupc-rac.sh <ORACLE_HOME> <ORACLE_SID> <BACKUP_DIR>" >&2
#   echo "Usage:  onlinebackupc-rac.sh $ORACLE_HOME $ORACLE_SID /global/cce_sm01n1if/oracle/db03/backup/online" >&2
   echo "" >&2
...
# backup archive log files and control file

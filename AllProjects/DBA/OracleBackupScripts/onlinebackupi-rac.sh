#!/usr/bin/sh
#
# Online Incremental backup of the RAC database
#
#
# MODIFIED
...
{
   echo "" >&2
   echo "Usage:  onlinebackupi-rac.sh <ORACLE_HOME> <ORACLE_SID> <BACKUP_DIR>" >&2
#   echo "Usage:  onlinebackupi-rac.sh $ORACLE_HOME $ORACLE_SID /global/cce_sm01n1if/oracle/db03/backup/incremental" >&2
   echo "" >&2

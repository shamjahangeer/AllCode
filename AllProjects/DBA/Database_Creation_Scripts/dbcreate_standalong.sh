...
{
   echo "" >&2
   echo "Usage:  dbcreate.sh <SUB_SYSTEM> <SID> <DOMAIN_NAME> <LISTENER_IP>" >&2
   echo "" >&2
...
sh /opt/db01/app/oracle/admin/${SID}/scripts/${SID}.sh

### Configure Listener & Tnsnames
sh /opt/db01/app/oracle/admin/${SID}/scripts/listener.sh

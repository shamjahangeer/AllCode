CREATE OR REPLACE VIEW SCD.GBL_BUSLN_FNCTN_GDS_DIM_V AS
SELECT
       ...
       b4.busln_fnctn_short_name dd5_busln_fnctn_short_name
FROM gbl_bsns_ln_drill_down_layers a,
     gbl_business_line_function b,
     gbl_business_line_function b1,
     gbl_business_line_function b2,
     gbl_business_line_function b3,
     gbl_business_line_function b4,
     gbl_business_line_function b5

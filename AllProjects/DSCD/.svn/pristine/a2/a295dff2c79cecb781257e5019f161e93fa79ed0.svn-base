CREATE OR REPLACE FORCE VIEW scd.order_item_open_curr_all_v (amp_order_nbr,
                                                             order_item_nbr,
                                                             shipment_id,
                                                             dml_oracle_id,
                                                             dml_tmstmp,
...
AS
   SELECT oio.amp_order_nbr, oio.order_item_nbr, oio.shipment_id,
          ...
          oio.sbmt_part_prcr_src_org_id, odim.organization_id -- scorecard org
                                                             ,
          ...
          NULL manufacturing_org_id                                 -- mfr org
                                   ,
          oio.budget_rate_book_bill_amt, oio.part_key_id, oio.mrp_group_cde,
...
DROP PUBLIC SYNONYM ORDER_ITEM_OPEN_CURR_ALL_V;

CREATE PUBLIC SYNONYM ORDER_ITEM_OPEN_CURR_ALL_V FOR SCD.ORDER_ITEM_OPEN_CURR_ALL_V;


GRANT SELECT ON SCD.ORDER_ITEM_OPEN_CURR_ALL_V TO GATD;

GRANT SELECT ON SCD.ORDER_ITEM_OPEN_CURR_ALL_V TO GBIS_DECISION_SUPPORT_ROLE;

GRANT SELECT ON SCD.ORDER_ITEM_OPEN_CURR_ALL_V TO SCD_ADMIN WITH GRANT OPTION;

GRANT SELECT ON SCD.ORDER_ITEM_OPEN_CURR_ALL_V TO SCD_PRODUCTION_ROLE;

GRANT SELECT ON SCD.ORDER_ITEM_OPEN_CURR_ALL_V TO SCD_SOURCE;

GRANT SELECT ON SCD.ORDER_ITEM_OPEN_CURR_ALL_V TO TE_DATAMARTS_WITH_COST;
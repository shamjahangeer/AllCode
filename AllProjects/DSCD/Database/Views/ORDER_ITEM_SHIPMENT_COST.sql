CREATE OR REPLACE FORCE VIEW scd.order_item_shipment_cost 
(amp_order_nbr,
 order_item_nbr,
 shipment_id,
 dml_oracle_id,
...
SELECT amp_order_nbr, order_item_nbr, shipment_id, dml_oracle_id,
       ...
       distr_ship_when_avail_ind, super_data_security_tag_id,
       sap_profit_center_cde, storage_location_id,
       ...
       requested_on_dock_dt, scheduled_on_dock_dt, ship_to_customer_key_id,
       ...
       intl_cmcl_term_additional_desc, intl_commercial_terms_cde
       ,consolidation_indicator_cde
       ,consolidation_dt
       ,sales_territory_cde
       ,ultimate_end_customer_key_id
...
WHERE  ois.super_data_security_tag_id NOT LIKE cor_user_security.get_user_security_encoded_str;
CREATE OR REPLACE VIEW SCD.ORDER_ITEM_OPEN_CURR_ALL_V
(amp_order_nbr, order_item_nbr, shipment_id, dml_oracle_id, dml_tmstmp, purchase_by_account_base, ship_to_account_suffix, prodcn_cntrlr_code, item_quantity, resrvn_level_1, resrvn_level_5, resrvn_level_9, quantity_released, quantity_shipped, iso_currency_code_1, local_currency_billed_amount, extended_book_bill_amount, unit_price, customer_request_date, amp_schedule_date, release_date, inventory_location_code, inventory_building_nbr, actual_ship_location, actual_ship_building_nbr, request_schedule_cmprsn_code, request_to_schedule_variance, current_to_request_variance, current_to_schedule_variance, received_to_request_variance, received_to_schedule_variance, release_to_schedule_variance, release_schedule_cmprsn_code, order_booking_date, order_received_date, order_type_id, regtrd_date, reported_as_of_date, database_load_date, purchase_order_date, purchase_order_nbr, prodcn_cntlr_employee_nbr, team_code, stock_make_code, product_code, ww_account_nbr_base, ww_account_nbr_suffix, a_territory_nbr, customer_reference_part_nbr, schedule_on_credit_hold_date, schedule_off_credit_hold_date, customer_credit_hold_ind, customer_on_credit_hold_date, temp_hold_on_date, temp_hold_off_date, customer_type_code, industry_code, product_busns_line_id, product_busns_line_fnctn_id, mfg_campus_id, mfg_building_nbr, remaining_qty_to_ship, industry_business_code, fiscal_month, fiscal_quarter, fiscal_year, sbmt_part_nbr, sbmt_customer_acct_nbr, brand_id, profit_center_abbr_nm, schd_tyco_month_of_year_id, schd_tyco_quarter_id, schd_tyco_year_id, sold_to_customer_id, invoice_nbr, delivery_block_cde, credit_check_status_cde, sales_organization_id, distribution_channel_cde, order_division_cde, item_division_cde, matl_account_asgn_grp_cde, data_source_desc, batch_id, organization_key_id, mfr_org_key_id, accounting_org_key_id, product_line_code, customer_acct_type_cde, part_prcr_src_org_key_id, controller_uniqueness_id, prime_worldwide_customer_id, sales_document_type_cde, material_type_cde, drop_shipment_ind, sales_office_cde, sales_group_cde, sbmt_part_prcr_src_org_id, scorecard_organization_id, group_organization_id, company_organization_id, accounting_organization_id, part_prcr_source_org_id, manufacturing_org_id, budget_rate_book_bill_amt, part_key_id, mrp_group_cde, storage_location_id, requested_on_dock_dt, scheduled_on_dock_dt)
AS
SELECT oio.amp_order_nbr
     , oio.order_item_nbr
     , oio.shipment_id
     , oio.dml_oracle_id
     , oio.dml_tmstmp
     ...
     , odim.organization_id                                                                                                   -- scorecard org
     , DECODE (odim.parent_organization_id, odim.company_organization_id, odim.organization_id, odim.parent_organization_id)  -- group org
     , odim.company_organization_id                                                                                           -- company org
     , accodim.organization_id                                                                                                -- accounting org
     , ppsodim.organization_id                                                                                                -- part prcr src org
     , NULL manufacturing_org_id                                                                                              -- mfr org
     , oio.budget_rate_book_bill_amt
     , oio.part_key_id
     , oio.mrp_group_cde
     , oio.storage_location_id

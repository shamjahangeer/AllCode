CREATE OR REPLACE VIEW SCD.SCD_ORGANIZATIONS_DMN AS
SELECT organization_key_id,
  to_date('25-SEP-2010','DD-MON-YYYY') effective_from_dt,
  effective_to_dt,
  organization_id,
  ...
  data_provider_ind,
  prior_month_end_ind,
  previous_prior_month_end_ind,
  prior_reorg_ind
FROM organizations_dmn
WHERE organization_id IN ('2100','2115','2121','2143','2144','2145','2148','2150','2151','2153')
AND effective_from_dt  = to_date('09-DEC-2010','DD-MON-YYYY')
UNION ALL
SELECT organization_key_id,
  effective_from_dt,
  effective_to_dt,
  ...
  prior_reorg_ind
FROM organizations_dmn
WHERE ( (organization_id NOT IN ('2100','2115','2121','2143','2144','2145','2148','2150','2151','2153'))
OR (organization_id          IN ('2100','2115','2121','2143','2144','2145','2148','2150','2151','2153')
AND effective_from_dt         > to_date('09-DEC-2010','DD-MON-YYYY')) )
-- ORDER BY organization_key_id,effective_from_dt;
